    ...
    <>
      <GeneralContext.Provider value={{ greetingTextRef }}>
        ...
        <div className="MobileDesignContainer">
          ...
          <span className="secondLargeMiddleDesign">A</span>
          <span className="secondLargeFirstLeftDesign">A</span>
          <span className="secondLargeSecondLeftDesign">A</span>
          <span className="secondLargeThirdLeftDesign">A</span>
          <span className="secondLargeFourthLeftDesign">A</span>
