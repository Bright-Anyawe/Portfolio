    ...
    <>
      <GeneralContext.Provider value={{ greetingTextRef }}>
        ...
        <div className="largeScreenDesignContainer">
          ...
          <span className="eighthLargeScreenSecondLeftDesign">A</span>
          <span className="eighthLargeScreenThirdLeftDesign">A</span>
          <span className="eighthLargeScreenFourthLeftDesign">A</span>
          <span className="eighthLargeScreenFifthLeftDesign">A</span>
          <span className="eighthLargeScreenSixthLeftDesign">A</span>
          <span className="eighthLargeScreenSevenLeftDesign">A</span>
          <span className="eighthLargeScreenEightLeftDesign">A</span>
          <span className="eighthLargeScreenFirstRightDesign">A</span>
          <span className="eighthLargeScreenSecondRightDesign">A</span>
          <span className="eighthLargeScreenThirdRightDesign">A</span>
          <span className="eighthLargeScreenFourthRightDesign">A</span>
          <span className="eighthLargeScreenFifthRightDesign">A</span>
          <span className="eighthLargeScreenSixthRightDesign">A</span>
          <span className="eighthLargeScreenSevenRightDesign">A</span>
          <span className="eighthLargeScreenEightRightDesign">A</span>{" "}
          <span className="eighthLargeScreenFirstLeftDesign">A</span>
          <span className="eighthLargeScreenFirstRightDesign">A</span>
        </div>
