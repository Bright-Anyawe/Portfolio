...
describe("App", () => {
  ...
  it("should render the other project section of the page", () => {
    ...
    const otherProjectSection = screen.getByTestId("otherProjectSection");

    expect(otherProjectSection).toBeInTheDocument();
  });
  ...
  it("should render the contact section of the page", () => {
    ...
    const contactSection = screen.getByTestId("featuredProject");
