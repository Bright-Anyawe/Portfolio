    ...
    <>
      <GeneralContext.Provider value={{ greetingTextRef }}>
        ...
        <div className="largeScreenDesignContainer">
          ...
          <span className="firstLargeMiddleDesign">A</span>
          <span className="firstLargeFirstLeftDesign">A</span>
          <span className="firstLargeSecondLeftDesign">A</span>
          <span className="firstLargeThirdLeftDesign">A</span>
          <span className="firstLargeFourthLeftDesign">A</span>
        </div>
