        ...
        <div className="introduction mobileScreenIntroEl">
          ...
          <div className="aboutMeContainer">
            ...
            <p className="aboutMeEl">
              ...
              real-world problems, which is one of the things I love to do. Since early age, I have alway yern to develop these software we have in this modern time move into the game developing which is my focus
            </p>
