        ...
        <div className="subFeaturedProjectContainer">
          ...
          <div className="aboutFeaturedWorkContainer">
            <p className="aboutFeaturedWork">
              A real-world <span className="featuredWorkGoalGetter">Goal Getter</span> that helps users track daily
              tasks, edit, delete, and create different projects with their
              respective to-dos.
            </p>
          </div>
          <img
