                ...
                <div className="secondProjectBody">
                  ...
                  <div className="secondProjectTextContainer">
                    <p className="secondProjectText">
                      A real-world <span></span> Cv generator that help user to build their cv 
                       for their professional work. Thanks to the cv app that provide
                        users features to download the cv after filling the form{" "}
