      ...
      <section className="experienceEl" data-testid="experienceSection">
        <div className="experienceDescriptionContainer">
          ...
          <div className="experienceDescription">
            ...
            and the Odin project curriculum has been a huge resource in helping
      ...
      <section className="courseContainer">
        <div className="courseInfo">
          ...
          <p className="skill">
            ...
            JavaScript, React, CSS3, Project testing, Figma usage and HTML with
            frameworks like Git and GitHub.
          </p>
        </div>
