          ...
          <div className="aboutMeContainer">
            ...
            <p className="aboutMeEl">
              ...
              real-world problems, which is one of the things I love to do. Since early age,
               I have alway been curious about how to develop these software
                we have in this modern time, and also to move
                into the game developing world which is my focus to achieve
            </p>
