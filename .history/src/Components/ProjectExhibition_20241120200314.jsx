                ...
                <div className="secondProjectBody">
                  ...
                  <div className="secondProjectTextContainer">
                    <p className="secondProjectText">
                      A real-world <span>Cv generator</span> that help user to
                      build their cv for their professional work. Thanks to the
                      cv app that provide users features to download the cv
