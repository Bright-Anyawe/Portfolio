        ...
        <div className="introduction mobileScreenIntroEl">
          ...
          <div className="aboutMeContainer">
            ...
            <p className="aboutMeEl">
              My name is <span className="identity">Anyawe Bright</span>, I'm a
              front-end developer in Ghana. I spend most of my time studying in
              order to improve upon my skills, using code to solve real-world
              problems, which is one of the things I love to do.
            </p>
