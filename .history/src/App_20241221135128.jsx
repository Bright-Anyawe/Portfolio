    ...
    <>
      <GeneralContext.Provider value={{ greetingTextRef }}>
        ...
        <div className="largeScreenDesignContainer">
          <span className="zeroLargeMiddleDesign">A</span>
          <span className="zeroLargeFirstLeftDesign">A</span>
          <span className="zeroLargeSecondLeftDesign">A</span>
          <span className="zeroLargeThirdLeftDesign">A</span>
          <span className="zeroLargeFourthLeftDesign">A</span>
          <span className="zeroLargeFirstRightDesign">A</span>
          <span className="zeroLargeSecondRightDesign">A</span>
          <span className="zeroLargeThirdRightDesign">A</span>
          <span className="zeroLargeFourthRightDesign">A</span>
        </div>
